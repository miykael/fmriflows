...
# Timestamp: 2020-10-25 17:15:07 UTC
# 
...
conda install -y -q --name neuro \
    ...
    "joblib" \
    "jupyter" \
    "jupyter_contrib_nbextensions=5" \
    "jupyterlab" \
    "matplotlib" \
    "nb_conda" \
    "nbformat" \
...
bash -c 'source activate mvpa && cd /home/neuro               && git clone git://github.com/PyMVPA/PyMVPA.git              && cd PyMVPA              && make 3rd              && python setup.py build_ext              && python setup.py install              && cd ..              && rm -rf PyMVPA              && source deactivate mvpa'
