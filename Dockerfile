...
# Timestamp: 2018-06-27 07:30:28 UTC
# 
...
COPY ["scripts/templates/HarvardOxford_labels.csv", "scripts/templates/parcellate_HarvardOxford.py", "scripts/templates/report_sub-placeholder.html", "scripts/templates/resample_icbm152.py", "/templates/"]
...
RUN echo '{ \
    ...
    \n        "scripts/templates/report_sub-placeholder.html", \
