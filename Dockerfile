...
# Timestamp: 2018-10-16 19:09:43 UTC
# 
...
COPY ["scripts/templates/HarvardOxford_labels.csv", "scripts/templates/parcellate_HarvardOxford.py", "scripts/templates/report_template_1stlevel.html", "scripts/templates/report_template_func.html", "scripts/templates/report_template.html", "scripts/templates/resample_icbm152.py", "/templates/"]
...
RUN echo '{ \
    ...
    \n        "scripts/templates/report_template_1stlevel.html", \
    \n        "scripts/templates/report_template_func.html", \
