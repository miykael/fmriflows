...
# Timestamp: 2018-07-14 15:29:48 UTC
# 
...
COPY ["scripts/templates/HarvardOxford_labels.csv", "scripts/templates/parcellate_HarvardOxford.py", "scripts/templates/report_template.html", "scripts/templates/resample_icbm152.py", "/templates/"]
